      ...
      <div className="flex w-full flex-col justify-center px-4 lg:w-1/2 lg:px-8">
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <button onClick={() => signIn("facebook", { callbackUrl: "/pruser/homepage" })} className="social-btn">
              <Facebook className="h-5 w-5 text-[#1877F2]" />
            </button>
            <button onClick={() => signIn("apple", { callbackUrl: "/pruser/homepage" })} className="social-btn">
